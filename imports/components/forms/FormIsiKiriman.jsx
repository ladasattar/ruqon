...
export const FormIsiKiriman = () => {
  ...
  const handleSubmitForm = async (e) => {
    ...
    navigate("/ruqyah-online/pilih-tumbal", { replace: false });
  };
      ...
      >
        <div className="d-flex flex-column">
          <div className="d-flex flex-column align-items-center my-5">
            <h1 className="f-ts mb-4">Kiriman Ruqyah</h1>
            <div className="w-100">
              <TargetInfo />
              <p className="mb-2 text-left">Kiriman Ayat</p>
            ...
            <div className="w-100 my-5">
              <p className="mb-2 text-left">Target Praktik</p>
              <div className="checkbox-group w-100">
                {efeks.map((efek) => (
                  <SquareCheckbox
                    key={efek._id}
