      ...
      <div className="d-flex flex-column">
        <div className="d-flex flex-column align-items-center my-5">
          ...
          <div className="payment-group px-5 mt-5 py-4 w-100">
            {props.type === "ruqyah" || props.type === "kirim-doa" ? (
              <TargetInfo />
            ) : (
              ""
            )}
            ...
            <div className="activity-detail mb-5">
              {props.type === "ruqyah" ? (
                <>
                  <p className="fs-6 mb-0 opacity-75">Kiriman Ayat</p>
                  <p>
                  ...
                  <p className="fs-6 mb-0 opacity-75">Target Praktik</p>
                  <p>
              ...
              <p className="fs-6 mb-0 opacity-75">Metode Amalan</p>
              <p>
                {
